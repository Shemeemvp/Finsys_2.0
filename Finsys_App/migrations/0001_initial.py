# Generated by Django 4.2.3 on 2024-05-02 05:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.date(2024, 5, 2))),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Finsys_App.fin_company_details')),
                ('login', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Finsys_App.fin_login_details')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='fin_attendances',
            name='company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Finsys_App.fin_company_details'),
        ),
        migrations.AddField(
            model_name='fin_attendances',
            name='employee',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Finsys_App.employee'),
        ),
        migrations.AddField(
            model_name='fin_attendances',
            name='login_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Finsys_App.fin_login_details'),
        ),
        migrations.CreateModel(
